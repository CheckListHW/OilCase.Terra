...
class Size(JsonInOut):
    ...
    def __init__(self, x_start: int = 0, x_end: int = 25, y_start: int = 0,
                 y_end: int = 25, z_start: int = 0, z_end: int = 25):
    ...
    def change_constraints(self, x_start: int = None, x_end: int = None, y_start: int = None,
                           y_end: int = None, z_start: int = None, z_end: int = None):
    ...
    @property
    def x(self) -> int:
        return 25  # int(abs(self.x_constraints.start - self.x_constraints.end))

    @property
    def y(self):
        return 25  # int(abs(self.y_constraints.start - self.y_constraints.end))

    @property
    def z(self):
        return 500  # int(abs(self.z_constraints.start - self.z_constraints.end))
